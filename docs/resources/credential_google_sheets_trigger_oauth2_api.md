...
page_title: "n8n_credential_google_sheets_trigger_oauth2_api Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_google_sheets_trigger_oauth2_api (Resource)
...
- `type` (String) n8n credential type (`googleSheetsTriggerOAuth2Api`).
