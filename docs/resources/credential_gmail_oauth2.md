...
page_title: "n8n_credential_gmail_oauth2 Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_gmail_oauth2 (Resource)
...
```terraform
resource "n8n_credential_gmail_oauth2" "example" {
  name              = "gmail"
...
- `type` (String) n8n credential type (`gmailOAuth2`).
...
```shell
#!/bin/bash
# terraform import n8n_credential_gmail_oauth2.example {credential_id}
terraform import n8n_credential_gmail_oauth2.example REPLACE_WITH_CREDENTIAL_ID
```
