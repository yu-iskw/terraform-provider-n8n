...
page_title: "n8n_credential_google_drive_oauth2_api Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_google_drive_oauth2_api (Resource)
...
- `type` (String) n8n credential type (`googleDriveOAuth2Api`).
...
```shell
#!/bin/bash
# terraform import n8n_credential_google_drive_oauth2_api.example {credential_id}
terraform import n8n_credential_google_drive_oauth2_api.example REPLACE_WITH_CREDENTIAL_ID
```
