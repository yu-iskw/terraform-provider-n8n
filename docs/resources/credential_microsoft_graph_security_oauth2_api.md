...
page_title: "n8n_credential_microsoft_graph_security_oauth2_api Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_microsoft_graph_security_oauth2_api (Resource)
...
- `type` (String) n8n credential type (`microsoftGraphSecurityOAuth2Api`).
