...
- `data` (Dynamic, Sensitive, [Write-only](https://developer.hashicorp.com/terraform/language/resources/ephemeral#write-only-arguments)) Credential payload for this type. Write-only; never stored in state. Change `data_version` to push an update.
