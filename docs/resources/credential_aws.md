...
page_title: "n8n_credential_aws Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
- `custom_endpoints` (Boolean) When true, send VPC custom service endpoints.
...
- `lambda_endpoint` (String) Custom Lambda endpoint.
...
- `temporary_credentials` (Boolean) When true, send session_token for STS temporary credentials.
...
- `type` (String) n8n credential type (`aws`).
