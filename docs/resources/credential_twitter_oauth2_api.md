...
page_title: "n8n_credential_twitter_oauth2_api Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_twitter_oauth2_api (Resource)
...
```terraform
resource "n8n_credential_twitter_oauth2_api" "example" {
  name              = "x-oauth"
...
- `type` (String) n8n credential type (`twitterOAuth2Api`).
