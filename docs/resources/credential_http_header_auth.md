...
page_title: "n8n_credential_http_header_auth Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_http_header_auth (Resource)
...
- `type` (String) n8n credential type (`httpHeaderAuth`).
...
```shell
#!/bin/bash
# terraform import n8n_credential_http_header_auth.example {credential_id}
terraform import n8n_credential_http_header_auth.example REPLACE_WITH_CREDENTIAL_ID
```
