...
- `access_token` (String, Sensitive) Slack bot access token. Write-only; never stored in state.
...
- `signature_secret` (String, Sensitive) Slack signing secret used to verify requests. Write-only; never stored in state.
