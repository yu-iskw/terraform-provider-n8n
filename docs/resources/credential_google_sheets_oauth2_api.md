...
page_title: "n8n_credential_google_sheets_oauth2_api Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_google_sheets_oauth2_api (Resource)
...
- `type` (String) n8n credential type (`googleSheetsOAuth2Api`).
...
```shell
#!/bin/sh
terraform import n8n_credential_google_sheets_oauth2_api.example <credential-id>
```
