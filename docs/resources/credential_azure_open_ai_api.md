...
page_title: "n8n_credential_azure_open_ai_api Resource - terraform-provider-n8n"
subcategory: ""
description: |-
...
# n8n_credential_azure_open_ai_api (Resource)
...
- `endpoint` (String) Optional custom Azure OpenAI endpoint, for example `https://westeurope.api.cognitive.microsoft.com`.
...
- `type` (String) n8n credential type (`azureOpenAiApi`).
